...
ChatLogic::~ChatLogic()
{
    ...
    // delete all nodes : No longer needed for Task 3
    // for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it) 
    // {
    //     delete *it;
    // }

    // delete all edges : No longer needed for Task 4
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
        ...
        while (getline(file, lineStr))
        {
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    {
                        //// STUDENT CODE
                        //// Task 3: Adjusting for _nodes vector made of GraphNode unique pointers.
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            //changes for task 3 from GraphNode* to std::unique_ptr<GraphNode>
                            ...
                            // create new edge
                            // Task 4: Adjusting for the new graphedge vector
    ...
    //Task 5: Creating a local chatbot instance 
